...
if(WITH_JPEG)
  ...
  elseif(MB_JPEG)
    ...
    if ( NOT JPEG_FOUND ) # MB patch begin
        ocv_clear_internal_cache_vars(JPEG_LIBRARY JPEG_INCLUDE_DIR)
        include(FindJPEG)
    endif()
  endif()
  ...
  if(MB_JPEG)
    ...
    set(JPEG_LIBRARY ${MB_JPEG_LIB} CACHE INTERNAL "")
    set(JPEG_LIBRARIES ${JPEG_LIBRARY})
    set(JPEG_INCLUDE_DIR "${MB_JPEG_LIB_INCLUDE_DIR}" CACHE INTERNAL "")
...
if(WITH_PNG)
  if(BUILD_PNG)
    ...
    if ( NOT PNG_FOUND ) # MB patch begin
